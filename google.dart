...
google(CommandEvent event) => event << (query) async {
  var json = await event.fetchJSON("http://ajax.googleapis.com/ajax/services/search/web?v=1.0&q=${Uri.encodeComponent(query)}");
